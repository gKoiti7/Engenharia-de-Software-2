...
if($ordem == 0){
    $result_usuario = "SELECT * FROM servidores_prefeitura ORDER BY nome ASC LIMIT $inicio, $qnt_result_pg";
    $resultado_usuario = mysqli_query($conn, $result_usuario);
}elseif($ordem == 1){
    $result_usuario = "SELECT * FROM servidores_prefeitura ORDER BY cargo ASC LIMIT $inicio, $qnt_result_pg";
    $resultado_usuario = mysqli_query($conn, $result_usuario);
}elseif($ordem == 2){
    $result_usuario = "SELECT * FROM servidores_prefeitura ORDER BY salario ASC LIMIT $inicio, $qnt_result_pg";
    $resultado_usuario = mysqli_query($conn, $result_usuario);
}
...
$result_pg = "SELECT COUNT(id) AS num_result FROM servidores_prefeitura";
